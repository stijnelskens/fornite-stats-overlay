...
var submitButton = document.getElementById('js-submit'); // submitButton.addEventListener('click', function(){
...
//     API.login("", "").then(() => {
//         API.MWwz(inputValue).then(data => {
//             console.log(data.br);  // see output
//             const wins = document.getElementById('wins');
//             const kills = document.getElementById('kills');
//             const kd = document.getElementById('kd');
//             wins.innerHTML = data.br.wins;
//             kills.innerHTML = data.br.kills;
//             kd.innerHTML = Math.round(data.br.kdRatio * 100) / 100;
//         }).catch(err => {
//             console.log(err);
//         });
//     }).catch((error) => {
//         logger.error(`Login failed: ${error} kut`);
//         return false;
//     });
// }
...
function getStats(inputValue) {
  axios.get("https://fortnite-api.com/v1/stats/br/v2/".concat(inputValue)).then(function (response) {
    // handle success
...
},{"axios":"node_modules/axios/index.js"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/cod-overlay.e31bb0bc.js.map